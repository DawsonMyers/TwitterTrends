...
//    static String fname = "./TwitterDataProcessor/data/tweets-100.txt";
    static String fname = "./TwitterDataProcessor/data/tweets-100k.txt";
    ...
    public static List<Tweet> readDataFromFile(String name) {

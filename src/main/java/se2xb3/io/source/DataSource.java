 ...
 * @since 3/10/2017
 */
public abstract class DataSource implements Runnable, Constants {

    protected String url = Constants.INPUT_FILE;
     ...
     *
     * @param controller the controller instances
     */
...
//        msgHandler = new MessageHandler(controller);
     ...
     * to be processed.
     *
     * @param msg a new message string
     */
     ...
     *
     * @param url a url for the data source
     */
